...
const Name DummyStrategy::STRATEGY_NAME("ndn:/localhost/nfd/strategy/dummy-route/%FD%01");
...
void
DummyStrategy::afterReceiveInterest(const Face& inFace,
                   ...
                   shared_ptr<pit::Entry> pitEntry)
{
  ...
  std::cout << "Fib entry name " << fibEntry->getPrefix() << "\n";
