...
#ifndef NFD_DAEMON_FW_DUMMY_ROUTE_STRATEGY_HPP
#define NFD_DAEMON_FW_DUMMY_ROUTE_STRATEGY_HPP
...
{
public:
  DummyStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);
